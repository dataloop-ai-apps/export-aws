...
class HookIntegrationAWS(dl.BaseServiceRunner):
...
def test():
    ...
    dl.setenv('rc')
    service_runner = HookIntegrationAWS(integration_name="")
    ...
    context = dl.Context()
    context._node = Node(metadata={'customNodeConfig': {'bucket_name': 'micha-test', 'region_name': 'us-east-1'}})
